...
assert.throws(
    function () {
        date('2017-05-16 13:45').subtract(2, 'light-years');
    },
    TypeError,

    'Если попытаться dsxtcnm к дате световой год, ' +
    'то выбросится исключение TypeError'
);

assert.throws(
    function () {
        date('2017-05-16 13:45').subtract(-2, 'years');
    },
    TypeError,

    'Если попытаться передать в функцию sub.. отрицательное число – выбросится исключение TypeError'
);
